...
class Bill_App:
    def __init__(self, root):
        ...
        bg_color = "#ADD8E6"
        title = Label(self.root, text="Bill Maker", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#ADD8E6", fg="Black", relief=GROOVE)
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#ADD8E6")
        ...
        c_bill_lbl = Label(F1, text="Bill Number:", bg="#ADD8E6", font=('times new roman', 15, 'bold'))
    ...
    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#ADD8E6")
        ...
        newsprin_lbl = Label(F2, text="Newsprin", font =('times new roman', 16, 'bold'), bg = "#ADD8E6", fg = "black")
    ...
    # ==========GroceryItems=========================
        F3 = LabelFrame(self.root, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#ADD8E6")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Cold Drinks", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#ADD8E6")
        ...
        limka_lbl = Label(F4, text="Limka", font=('times new roman', 16, 'bold'), bg="#ADD8E6", fg="black")
        ...
        mazza_lbl = Label(F4, text="Mazza", font=('times new roman', 16, 'bold'), bg="#ADD8E6", fg="black")
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Duo", font=('times new roman', 16, 'bold'), bg="#ADD8E6", fg="black")
    ...
    # =======================ButtonFrame=============
        F6 = LabelFrame(self.root, text="Bill Area", font=('times new roman', 14, 'bold'), bd=10, fg="Black", bg="#ADD8E6")
